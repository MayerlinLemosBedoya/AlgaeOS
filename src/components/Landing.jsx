export default function Landing() {
  ...
  const links = {
    app: "/app", // point to your app route
    ...
    <main className="min-h-screen bg-gradient-to-b from-emerald-900 via-emerald-950 to-black text-white">
      ...
      <nav className="sticky top-0 z-20 backdrop-blur-md/30 bg-black/30 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <a href={links.github} className="px-3 py-2 text-sm text-white/80 hover:text-white" target="_blank">GitHub</a>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 md:py-28 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <a href={links.blockscoutContract} target="_blank" className="px-5 py-3 rounded-xl border border-white/20 hover:bg-white/5">View contract</a>
            </div>
            ...
            <div className="relative rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl">
              <div className="grid gap-4 text-sm">
                ...
                <div>
                  ...
                  <a href={links.blockscoutContract} target="_blank" className="block font-mono text-xs break-all hover:text-emerald-300">0x7e0334…78144</a>
                </div>
                <div>
                  <p className="text-white/70 mb-1">PYUSDt</p>
                  <a href={links.blockscoutToken} target="_blank" className="block font-mono text-xs break-all hover:text-emerald-300">0xb42290…39df</a>
                </div>
      ...
      <section id="how" className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="mt-8 flex gap-3">
          ...
          <a href={links.blockscoutContract} target="_blank" className="px-5 py-3 rounded-xl border border-white/20 hover:bg-white/5">See on Blockscout</a>
        </div>
      </section>
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-10 grid md:grid-cols-2 gap-6">
          ...
          <div className="md:text-right flex md:justify-end gap-3 items-center">
            <a className="px-3 py-2 text-sm text-white/80 hover:text-white" href={links.github} target="_blank">GitHub</a>
            <a className="px-3 py-2 text-sm text-white/80 hover:text-white" href={links.devpost} target="_blank">Devpost</a>
            <a className="px-3 py-2 text-sm text-white/80 hover:text-white" href={links.docs} target="_blank">Docs</a>
          </div>
        </div>
      </footer>
    </main>
